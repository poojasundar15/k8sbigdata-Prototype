...
package ch.niceideas.bigdata.utils;
...
public class EncodedPasswordGeneratorTest {
    ...
    public void testEncodePassword() {
        doTestPassword("password");
        doTestPassword("test");
        doTestPassword("$!**12(+ba-;.");
        doTestPassword("éàèçç$£");
    }

    void doTestPassword(String passwordTotest) {
        String encodedPassword = new EncodedPasswordGenerator().encodePassword(passwordTotest);

        BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder(11);
        assertTrue (passwordEncoder.matches(passwordTotest, encodedPassword));
    }
