...
public class EskimoUtilsOtherTest {

    private static final Logger logger = Logger.getLogger(EskimoUtilsOtherTest.class);
    ...
    @Test
    public void testGetLastTag() throws Exception {
        createTestScript("test_get_last_tag_cerebro.sh", "get_last_tag cerebro");

        String result = ProcessHelper.exec(new String[]{"bash", jailPath + "/test_get_last_tag_cerebro.sh"}, true);
        System.err.println (result);

        assertEquals ("1\n", result);

        createTestScript("test_get_last_tag_zeppelin.sh", "get_last_tag zeppelin");

        result = ProcessHelper.exec(new String[]{"bash", jailPath + "/test_get_last_tag_zeppelin.sh"}, true);
        System.err.println (result);
