...
public class EskimoKubernetesOperationsCommandTest extends AbstractWebTest {
    ...
    public void setUp() throws Exception {
        ...
        waitForDefinition("window.eskimo.KubernetesOperationsCommand");
    ...
    public void testShowCommand() throws Exception {
        ...
        String command = StreamUtils.getAsString(ResourceUtils.getResourceAsStream("EskimoKubernetesOperationsCommandTest/command.json"), StandardCharsets.UTF_8);

        js("eskimoKubernetesOperationsCommand.showCommand("+command+".command)");

        String expectedResult = StreamUtils.getAsString(ResourceUtils.getResourceAsStream("EskimoKubernetesOperationsCommandTest/expectedResult.html"), StandardCharsets.UTF_8);
        ...
        assertJavascriptEquals(
                expectedResult
                        ...
                        .replace("\n", "")
                        .replace("  ", ""),
                "$('#kubernetes-operations-command-body').html()");
    }
