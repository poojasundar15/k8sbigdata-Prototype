...
public interface SetupService {
    ...
    String getConfigStoragePath() throws SetupException;

    String getPackagesDownloadUrlRoot();

    void ensureSetupCompleted() throws SetupException;

    SetupCommand saveAndPrepareSetup(String configAsString) throws SetupException;

    Pair<String,String> parseVersion(String name);

    String findLastPackageFile(String prefix, String packageName);
    ...
    int compareSoftwareVersion (String firstVersion, String secondVersion);

    String getStoragePathConfDir();
}
